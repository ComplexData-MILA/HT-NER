...
class BaseModel(AutoModelForPreTraining):
...
class BaseTokenClassification(BaseModel):
    def __init__(self, config):
        super(BaseTokenClassification, self).__init__(config)
...
class BaseGlobalPointer(BaseTokenClassification):
...
class BaseCRF(BaseTokenClassification):
    def __init__(self, config):
        super(BaseCRF, self).__init__(config)
