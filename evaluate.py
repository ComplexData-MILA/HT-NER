...
parser.add_argument("--prediction", type=str, help="Location of prediction CSV file.")
parser.add_argument(
    "--prediction_column",
    nargs="+",
...
for gt_col, pred_col in zip(args.ground_truth_column, args.prediction_column):
