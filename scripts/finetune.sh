...
python3 src/finetune_evaluation.py --base-model ./saved_models/roberta-base-wikiner-en/checkpoint-6500 --datasets wikiner-en
...
python3 src/finetune_evaluation.py --base-model ./saved_models/deberta-v3-base-polyglot_ner/checkpoint-16565 --datasets polyglot_ner
python3 src/finetune_evaluation.py --base-model ./saved_models/roberta-base-polyglot_ner/checkpoint-16565 --datasets polyglot_ner
